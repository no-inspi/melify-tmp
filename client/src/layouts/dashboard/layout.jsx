...
import { EmailFilterProvider } from './context/emailProvider';
    ...
    <SearchProvider>
      <EmailFilterProvider>
        ...
        {/* <button
          type="button"
          onClick={handleClick}
          className="fixed bottom-4 right-20 w-24 h-24 bg-cover bg-center rounded-full hover:scale-105 transition-transform"
          style={{
            backgroundImage: "url('/assets/aiassistanttransparent.gif')",
          }}
        >
        </button> */}
      </EmailFilterProvider>
